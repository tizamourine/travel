  ...
  font-weight: bold;
	...
	<body>
		...
		<section id="home" class="about-us" style="z-index: 1; height: 100%;">
			<header class="header">
				<h2 style="font-size:xx-large;text-align:center">Profil Administrateur</h2>
			</header>
			...
			<section class="contai">
				...
				<div class="card">
				<?php
				if($admin->notification()>0){
				echo <<<'EOT'
				<div class="notification-container">
				<span class="notification-circle"  style="display:flex;";>
				EOT;
				 echo $admin->notification()."</span> </div>";
				}
				  ?>
					<a href="administration.php">
					<button class="mon-bouton">ADMINISTRATION</button>
				</a>
				</div>
			
				<div class="card">
				<?php
				if($admin->parent->notification()>0){
				echo <<<'EOT'
				<div class="notification-container">
				<span class="notification-circle"  style="display:flex;";>
				EOT;
				 echo $admin->parent->notification()."</span> </div>";
				}
				  ?>
					<a href="profileAgent.php">
					<button class="mon-bouton1">AGENT</button>
					</a>
