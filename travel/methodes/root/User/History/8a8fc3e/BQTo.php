...
function headerAvecSession($bdd, $client){
  ...
  <div class="list"><img class="img" width="10%" height="3%" src="assets/images/arbre.png" alt="">
...
function reservation($image, $offre,$nom, $status, $date, $progression, $idReservation){
  echo '<div class="settings-container">';
              ...
              if ($status == "attente")
							echo '<button class="annuler" type="button" value="'.$idReservation.'" style="position:absolute;right:3px;bottom:3px;background-color:#008CBA;height: 40px;width: 90px;padding: 10px;text-align:center;color:white;">Annuler</button>';
              echo "</div>";
}
?>