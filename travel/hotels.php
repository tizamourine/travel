			...
			<div class="scrollable-div" style="background-color:white;">
				...
				if (count($hotels) == 0) echo "<p> aucun hotel de la sorte. </p>";
							foreach ($hotels as $hotel){
								...
								echo '<img src="'.$bdd->recupererHotelImage($hotel->getIdHotel())[0].'" alt="Image 1" style="display: inline-block;">';
							...
							echo '<p>Nom: '.$hotel->getNomHotel().'</p>';
							echo '<p>Adresse: '.$hotel->getAdresse().'</p>';
							echo '<p>Étoiles: '.$hotel->getEtoiles().'</p>';
							echo '<p>Numéro de téléphone: '.$hotel->getNumTel().'</p>';
							echo '<p>Ville: '.$hotel->getVille().'</p>';
							echo '<p>Coordonnées: '.$hotel->getCoordonne().'</p></div>';
					
							echo '<a href="chambres.php?idHotel='.$hotel->getIdHotel().'" style="position:absolute;right:3px;bottom:3px;background-color:#008CBA;height: 40px;width: 90px;padding: 10px;text-align:center;color:white;">Reserver</a></div>';
							}
							?>
