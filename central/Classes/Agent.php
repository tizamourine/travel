...
class Agent extends Utilisateur{
    ...
    public function notification(){
        $messages = $this->bdd->recupererListeMessageNonLu($this->getIdAgent());
        $reservations = $this->bdd->recuperAgentReservation($this->getIdAgent());
        return count($messages)+count($reservations);
    }
}
?>
