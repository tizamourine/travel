        ...
        <div class="container">
            <div class="signup-content" style="" >
                <form method="POST" action="verifierCl.php" id="signup-form" class="signup-form">
                    ...
                    <div class="form-group">
                        <label for="agree-term" class="label-agree-term"><span> <span></span> </span>Si vous n'avez pas de compte <a href="inscription.php" class="term-service" style="color:#222222; text-decoration:#222222;">S'inscrire.</a></label>
