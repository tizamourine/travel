...
<body>
  <?php
    if($bdd->verifierSession($session) == 1){
      echo $bdd->verifierSession($session);
...
<header class="top-area">
    ...
    <div class="main">
        ...
        <div class="container">
            <div class="signup-content" >
                <form method="POST" action="ajouterCl.php" id="signup-form" class="signup-form">
                    <h2 style="font-size:36px">S'inscrire </h2>
                    <h3 id="commentaire"><?php
                    ...
                    <?php
                  if ($q == 1){
                        echo '<h3 style="text-decoration:green">Inscription réussie.</h3>';
                  }
                    ?>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-input" name="numTel" id="numTel" placeholder="Numero de téléphone"/>
                    </div>
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <input type="password" class="form-input" name="mdp2" id="password" placeholder="Confirmer mot de passe"/>
                        <span toggle="#password" class="zmdi zmdi-eye field-icon toggle-password"></span>
                    </div>
                    <div class="form-group">
                      <select class="form-input" name="sexe" style="background-color:rgba(77, 177, 177, 0.75);width:80%;text-align:center;">
                        <option default>Sexe</option>
                        <option>Homme</option>
                        <option>Femme</option>
                      </select>
                    </div>
                    <div class="form-group" id="fom" >
                      <select class="form-input" name="identite" style="background-color:rgba(77, 177, 177, 0.75);width:80%;text-align:center;">
                        <option default>Identité</option>
                    ...
                    <div class="form-group">
                        <input type="num" class="form-input" name="numIdentite" id="numIdentite" placeholder="Numero d'identite'"/>
                    </div>
                    <div class="form-group" style="font-size:14px;text-transform:none">
                        <input type="checkbox" name="agree-term" id="agree-term" class="agree-term" />
                        <label for="agree-term" class="label-agree-term"><span><span></span style="font-size:10px"></span>J'accepte toutes les <a href="#" class="term-service">Conditions d'utilisation</a></label>
                    </div>
                    <div class="form-group">

                        <input type="button" id="inscrire" class="form-submit submit" value="S'inscrire"/>
                        <a href="connexion.php" class="submit-link submit">Se Connecter</a>
    ...
    <script>
			...
			let bouton = document.getElementById('inscrire');
      ...
      let numTel = input[3];
			let mdp1 = input[4];
			let mdp2 = input[5];
      let numIdentite = input[6];
      let agree = input[7];
      select = form.getElementsByTagName('select');
      let sexe = select[0];
      let identite = select[0];
			let commentaire = form.getElementsByTagName('h3')[0];
			function verifier(){
				if(mdp2.value=="" || mdp1.value=="" || email.value==""|| nom.value=="" || prenom.value=="" || sexe.value=="Sexe" || identite.value=="Identité" || numIdentite.value==""){
          ...
          commentaire.setAttribute("style", "text-decoration:red");
					commentaire.innerHTML = "Veuillez agreer les conditions";
        }else{
					form.submit();
				}
			}
