...
<html class="no-js"  lang="en">
	...
	input[type="submit"] {
		...
		<?php
				...
				$Reservations = $bdd->recuperClientReservation($client->getIdClient());
			?>
		...
		<div class="search-input">
			...
			<div class="scrollable-div" style="background-color:white;">
				...
				if (isset($_GET['s'])){$Reservations = $bdd->searchReservation($_GET['s']);
                if($_GET['s'] == "") $Reservations = $bdd->recuperClientReservation($client->getIdClient());}
	...
	<form>
			...
			function sHotel(i){
				form.setAttribute("action", "annulerReservation.php?idReservation="+s[i].value);
